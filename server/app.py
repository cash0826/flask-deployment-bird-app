...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('postgresql://bird_o6qj_user:JMuzz8vg33uPCbqWksfW6Rrpfv2PJsYn@dpg-d851v93bc2fs73clme70-a.virginia-postgres.render.com/bird_o6qj')
